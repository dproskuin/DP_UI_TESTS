...
from settings import Urls, Const, Variables
...
class PangoJuneProjectPage(BasePage):
    ...
    def users_search_field_displayed(self):
        return self.element_by_visible_text_is_present(Variables.SEARCH_USERS_BUTTON, "div")
    ...
    def verify_countries_screen_displayed(self):
        ...
        return self.element_by_visible_text_is_present(Variables.ADD_LOCATION_BUTTON, "div")
    ...
    def verify_locations_displayed(self):
        ...
        return self.element_by_visible_text_is_present(Variables.SERVER_POOLS, "div")
    ...
    def verify_billing_page_displayed(self):
        ...
        time.sleep(5)
        self.find_element_by_visible_text(Variables.SHOW_FEATURES_BUTTON).click()
        return self.element_by_visible_text_is_present(Variables.USER_MANAGEMENT, "div")
    ...
    def verify_add_project_button_navigation(self):
        self.find_and_click_element_by_visible_text(Variables.ADD_PROJECT_BUTTON)
        return self.element_by_visible_text_is_present(Variables.CREATE_PROJECT, "h1")

    def verify_ability_to_add_and_delete_country(self):
        self.open_countries_tab()
        if self.element_by_visible_text_is_present("Germany", "div") is True:
            add_button = self.find_element_by_visible_text(Variables.ADD_LOCATION_BUTTON)
    ...
    def verify_ability_to_change_projects_view_to_list(self):
        ...
        return self.element_by_visible_text_is_present(Variables.COMPANY_NAME_STRING, "div")

    def open_locations_loading_tab(self):
        self.find_and_click_element_by_visible_text(Variables.LOCATION_LOADING_BUTTON)

    def verify_locations_loading_tab_opened(self):
        self.navigate(Urls.PANGO_JUNE_03_DASHBOARD)
        time.sleep(1.5)
        self.open_locations_loading_tab()
        return self.element_by_visible_text_is_present(Variables.LOCATION_LOADING_MAP, "div")
